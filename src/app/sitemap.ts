...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const staticPages: MetadataRoute.Sitemap = [
        ...
        { url: `${BASE_URL}/guardian/journey`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
        { url: `${BASE_URL}/guardian/resources`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
