...
Rectified:                   ${defects.filter((d) => d.status === "rectified" || d.status === "verified").length}
...
${parseFloat(variationPercent) > 10
                    ? `
⚠️ WARNING: Variations exceed 10% of contract value.
...
================================================================================
${variations.filter((v) => v.status === "rejected").length === 0
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800/50 border border-border rounded-xl">
                <p className="text-sm font-medium mb-3 text-gray-700 dark:text-gray-300">📁 Select Download Format:</p>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    ...
                    {selectedFormat === "pdf" && " — Opens print dialog where you can 'Save as PDF'"}
                </p>
            </div>
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <h4 className="font-bold text-blue-800 mb-2">📝 About These Reports</h4>
                <ul className="text-sm text-blue-700 space-y-1">
                    <li>• Reports are generated as plain text files for maximum compatibility</li>
                    <li>• The Dispute Package is formatted for NSW Fair Trading submission</li>
                    <li>• Always attach photos, contracts, and certificates as supporting evidence</li>
